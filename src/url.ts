...
// 获取分钟线SSE
export const minLine = (code: string) =>
...
// 获取tick数据SSE
export const tickLine = (code: string) =>
...
// 获取资金流向
export const moneyflow = (code: string) =>
...
// Kline
export const kline = (code: string) =>
	...
	export const kline2 = (code: string) =>
...
// 季度利润
export const profitq = (code: string) =>
